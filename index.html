...
<body>
    <header>
        ...
        <nav id="menu-h" class="menu-hide">
            <ul>
                <li><a href="./" id="icon-nav-current">Home</a></li>
    ...
    <section id="text-home-container">
        <p id="text-home">As a man thinks in his heart, so is he.</p>
        <div id="proverb">
            Proverbs 23:7
        </div>
    </section>
    <footer>
        <p>Aguiar - FullStack Engineer. E-mail: aguiarjr897@gmail.com</p>
...
<script>
    function toggleMenu() {
        var menu = document.getElementById("menu-h");
